(function (window, document) {
  ...
  function showAdminPanel() {
    const { loginPanel, adminPanel } = getElements();
  ...
  function init() {
    ...
    if (document.documentElement.dataset.cloudnoteMainInitialized === 'true') return;
    document.documentElement.dataset.cloudnoteMainInitialized = 'true';
